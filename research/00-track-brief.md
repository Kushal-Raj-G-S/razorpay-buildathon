# All 5 tracks — verbatim briefs

Source: https://razorpay.com/buildathon/ · scraped 2 September 2026
(Full text extracted from the page's DOM; the visible UI only renders Track 01 by default.)

---

## Program framing

> Think you can build real AI? **Prove it.** A student-only program to discover and hire our
> next generation of AI Builder Interns.
>
> Students only. 6 or 12 month AI Builder Internship. In-person, Bangalore, from September.
>
> No resume screening. No long application. Four steps: pick a track, build something real,
> show your work (a public repo, a 5 minute pitch video, the architecture), and if it has
> signal we call you in.

---

## 01 — AI Growth & Agentic Commerce  ← **SELECTED**

**Grow the merchant's revenue, and make them sellable to AI buyers.**

Build an agent that grows revenue for a merchant on Razorpay test-mode APIs, or that makes a
merchant transactable by an AI buyer end to end.

- **Why now:** NPCI's UAP and the global protocol race (ACP, AP2, x402) make agent-to-agent
  commerce the open problem of the year, and Razorpay's in-app pilots are already live.
...
- **Why now:** Revenue loss rarely happens in one clean step. A payment degrades, a checkout
  ...
  the money.
- **Example directions:** Payment degradation → root cause → recovery action · Checkout
  drop-off recovery · Failed-subscription recovery · B2B receivables chaser · Mandate retry
...
Have an idea that doesn't fit the tracks above? Build it. Pick a real problem, use AI
meaningfully, and show us something that works. Any domain, workflow, or user is fair game.

- **Why now:** The best ideas don't always fit a predefined category. This track exists for
  builders who see an opportunity we didn't.
- **Example directions:** Surprise us · Solve a problem you deeply understand · Build
  something we haven't thought of
- **The bar:** Open doesn't mean easier. Show a real problem, a working product, meaningful use
  of AI, and evidence that it creates value. The same bar for execution, reliability, and depth
  applies here.

---

## Strategic read on track choice

**Important competitive fact:** Razorpay's own **Agent Studio** (launched at FTX'26, built on
Anthropic's Claude Agent SDK) already ships production agents for *cart recovery, subscription
retry, dispute management, cashflow forecasting and RTO reduction*.

That means **Tracks 03 and 04 are largely already productized in-house** — a submission there
gets implicitly benchmarked against Razorpay's shipping product. Track 01's territory
(agent-readable catalogs, AI-buyer-readiness, agent-initiated checkout trust) is where their
own stack is least mature and the external protocols are least settled → most white space.

Source: https://razorpay.com/newsroom/razorpay-launches-the-worlds-first-ai-native-agent-studio-for-payments-at-ftx26-powered-by-anthropics-claude/
